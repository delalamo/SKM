...
**Coupling backbone and side chain prediction and/or design leads to worse results than a two-step approach** [^chu2023][^vangaru2025]. For protein backbone design, [^chu2023] found that co-designing side chains during diffusion led to unrealistic side chain geometries, and avoided it by running a final redesign/repack at the end of design. For protein side chain prediction, [^vangaru2025] found that AlphaFold3 performs worse that AlphaFold2 on sidechain prediction.
