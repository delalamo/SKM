...
---
#### Summary
 **Protein [[protein-backbone-design#Diffusion|structure diffusion]] works best on small protein sizes.** [@watson2023] tried to refold proteins generated using RF-diffusion and [[ProteinMPNN]] and using [[alphafold2|AlphaFold2]] (single sequence) and found that they generally disagreed if they were too big. Likewise, [@ingraham2023] could not reliably refold proteins *in silico* if they were greater than ~200-300 residues.
