...
---
#### Summary
In protein [[tags/structure-prediction|structure prediction]], **uncertainty metrics** are used to evaluate the correctness of a structural model at various levels. They have been applied to protein design tasks in ways analogous to energy functions, prompted in part by the observation that these networks have learned an implicit energy function — even though they cannot be used directly for design.
