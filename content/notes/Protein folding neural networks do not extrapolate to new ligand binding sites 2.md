...
**Protein folding neural networks do not extrapolate to new ligand binding sites** ([d'Oelsnitz et al 2024][^doelsnitz2024], [Dürr & Rothlisberger 2024][^drr2024]). [[AlphaFold|AlphaFold2]] could not predict a new calcium-binding site in an engineered protein, and instead introduced a fictitious salt bridge ([d'Oelsnitz et al 2024][^doelsnitz2024]). Separately, neither [[AlphaFold|AlphaFold3]] nor [[RosettaFold|RosettaFold-AA]] could predict that a binding site prefers cobalt over copper ([Dürr & Rothlisberger 2024][^drr2024]).
