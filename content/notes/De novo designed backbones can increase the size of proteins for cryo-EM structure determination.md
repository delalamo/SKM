...
---
#### Summary
 ***De novo* [[tags/protein-backbone-design|designed backbones]] can be used to increase the size of proteins for [[cryo-EM]] structure determination** [@gao2024]. In one case, a domain designed with [[tags/diffusion-models|RF-diffusion]] was inserted into an intracellular loop of a [[G protein-coupled receptors|G-protein coupled receptor]].
