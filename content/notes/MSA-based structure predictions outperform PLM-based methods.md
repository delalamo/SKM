...
**Protein [[Structure prediction|structure prediction]] methods reliant on [[Multiple sequence alignments|MSAs]] outperform those that use [[Protein language models|PLMs]]**. This was observed in [[CASP15]] and documented by  Hu et al 2022[^hu2022] and Barrett et al 2022[^barrett2022].

#### Details

This may stem from the superior performance of these methods on contact prediction (documented by the authors of [[MSA Transformer]]; Rao et al 2021[^rao2021]) and structure interface scoring (Liu et al 2023[^liu2023]).
