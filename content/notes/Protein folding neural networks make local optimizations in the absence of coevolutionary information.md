...
**[[tags/structure-prediction|Protein folding neural networks]] make local optimizations in the absence of coevolutionary information** [@gut2024]. This was observed using [[tags/alphafold2|AlphaFold2]] and includes side chain optimizations and resolution of steric clashes. The observation is consistent with the hypothesis put forth by Roney & Ovchinnikov [@roney2022] that they learn an energy function but require evolutionary info to traverse the structural space.
