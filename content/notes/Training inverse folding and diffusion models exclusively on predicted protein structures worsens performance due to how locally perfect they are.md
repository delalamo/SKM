...
[@lin2023generating] trained a version of the [[notes/protein-backbone-design|backbone]] [[notes/diffusion-models|diffusion model]] GENIE on [[notes/alphafold2|AlphaFold2]] models from SwissProt and found that although designability increased was greater than a model trained on the PDB, diversity was lower.
