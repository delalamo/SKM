...
[@lin2023generating] trained a version of the [[tags/protein-backbone-design|backbone]] [[tags/diffusion-models|diffusion model]] GENIE on (AlphaFold2) models from SwissProt and found that although designability increased was greater than a model trained on the PDB, diversity was lower.
