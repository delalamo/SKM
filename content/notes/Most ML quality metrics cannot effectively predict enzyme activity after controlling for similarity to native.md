...
**The activity of synthetic sequences that were experimentally generated and tested by [@johnson2024] could not be distinguished using common ML/statistical quality metrics.** These include [[notes/pLDDT|pLDDT]], [[ESM]]-1v or MSA-transformer probabilities, [[notes/BLOSUM62|BLOSUM62]] distance or sequence identity from template, [[Rosetta]] scores, [[ESM-IF]] or [[ProteinMPNN]] probabilities, or [[Convolutional neural networks|CNN]]-based probabilities. These were designed using either [[MSA Transformer]], [[notes/Ancestral sequence reconstruction|Ancestral sequence reconstruction]], a generative adversarial network, or simply randomly chosen natural sequences ("test" in figure below). Slightly less than half were active.
