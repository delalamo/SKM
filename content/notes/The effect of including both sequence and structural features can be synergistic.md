...
---
#### Summary
**The benefit of including both sequence- and structure-based features during [[Inverse folding]] is greater than the sum of each feature's benefit in isolation** (Wang et al 2023b[^wang2023]).
...
*Table 3 from Wang et al 2023b[^wang2023]*
