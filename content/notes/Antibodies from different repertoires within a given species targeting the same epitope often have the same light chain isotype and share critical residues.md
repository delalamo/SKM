...
---
#### Summary
**[[tags/antibodies|Antibodies]] from different [[tags/immune-repertoires|immune repertoires]] from the same species that target the same epitope often have the same [[tags/light-chains|light chain isotype]]** [@shrock2023]. This was tested on disordered peptide truncates from common viral targets and is attributed to [[GRAB motifs]] in [[Germline|germline]] antibodies. It is related to the funding of [[Light chain coherence|light chain coherence]], whereby functional antibodies with the same CDRH3 share the same light chain.
