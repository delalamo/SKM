...
#### Summary
**Secondary structure losses are required to enforce [[Complementarity-determining regions|CDR]] loopiness during [[De novo antibody design|de novo antibody design]] by [[Inversion of protein folding neural networks|hallucination]]** (Mille-Fragoso et al 2025[^millefragoso2025]). Note that the alpha-helical term was originally introduced in BindCraft (Pacesa et al 2025[^pacesa2025]).
