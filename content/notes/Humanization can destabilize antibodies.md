...
#### Details
Bahrami [@bahrami2023] give an example of a [[Nanobodies|nanobody]] that had its framework changed such that its [[Complementarity-determining regions|CDR3]] conformation changed from [[Kinked CDRH3 loops|kinked]] to extended. In the process its [[tags/thermostability|thermostability]] dropped by 10°C.
