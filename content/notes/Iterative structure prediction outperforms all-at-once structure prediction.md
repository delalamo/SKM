...
**Iterative [[tags/structure-prediction|protein structure prediction]] outperforms all-at-once structure prediction** [@hayes2025]. This was pronounced for difficult targets (e.g., [[CASP14]] and [[CASP15]] proteins), whereas easy targets (CAMEO) could be predicted using either approach.
