...
---
#### Summary
 **Larger [[tags/protein-language-models|protein language models]] are better able to predict thermostability** [@hermann2024]. This is likely related to their ability to [[Protein property prediction using PLMs does not benefit from scale except when predicting inferring features of either structural or sparsely populated sequence families|better model structures]].
