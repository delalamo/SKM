...
**Structure-based methods, such as [[notes/inverse-folding|inverse folding models]], outperform sequence-based methods such as [[notes/protein-language-models|protein language models]] and [[Potts models]] at zero-shot [[notes/thermostability#Prediction|binding prediction]], whereas the reverse is true for zero-shot [[Fitness prediction|prediction of enzymatic activity]]** [@li2024c].
