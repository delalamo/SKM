...
#### Details
In the context of [[tags/protein-language-models|protein language models]], the features extracted from intermediate layers [[Sparse autoencoder-derived features do not outperform PLM-derived embeddings for downstream prediction|do not outperform the embeddings from which they are derived on property prediction]].
