...
---
#### Summary
Beta-sheets are less designable than alpha helices using [[Inverse folding]] models (Wang et al 2023[^wang2023]). This was true for a range of models.
...
*Figure by Wang et al 2023[^wang2023]*
