...
#### Summary
**[[tags/evolution-and-natural-selection|Coevolutionary patterns]] in [[Multiple sequence alignments|multiple sequence alignments]] do not contribute to accurate modeling of [[tags/protein-protein-interactions|protein-protein interactions]]** [@li2026]. Instead, correct docking appears to be driven by interactions (unlike for [[Protein folding neural networks cannot predict protein stability|protomers]]), which are more susceptible to disruption by mutations. This contrasts with [[Protein-ligand co-folding methods do not generalize beyond their training set|observations made for small molecules]].
