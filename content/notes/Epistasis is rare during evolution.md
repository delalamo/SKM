...
Alcantar et al. carried out a "combinatorially complete" analysis of mutations introduced during [[tags/affinity-maturation|affinity maturation]] of *de novo* designed minibinders and found that the binding improvements were basically entirely additive, which is similar to [[tags/antibodies|antibodies]] ([[Mutations obtained by antibodies during affinity maturation show epistasis in biophysical properties but not binding]]). [@alcantar2025]
