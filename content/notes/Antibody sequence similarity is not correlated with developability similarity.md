...
#### Summary
**(Antibody) sequence similarity is not correlated with (developability) similarity** [^bashour2024]. Most of the sequence variation is in [[Complementarity-determining regions#CDRH3|CDRH3]], whereas [[Framework region|framework residues]] had an outside impact on actual effects.
