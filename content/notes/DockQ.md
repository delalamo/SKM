...
**DockQ** is a metric ranging from zero to one that is used to evaluate [[notes/structure-prediction|predicted structures]] of [[notes/protein-protein-interactions|protein complexes]] [@basu2016]:
