...
**DockQ** is a metric ranging from zero to one that is used to evaluate [[tags/structure-prediction|predicted structures]] of [[tags/protein-protein-interactions|protein complexes]] [@basu2016]:
