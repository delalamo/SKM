...
#### Summary
**[[Reinforcement learning]] (here, DPO) outperforms fine-tuning on property-guided [[tags/inverse-folding|inverse folding]]** [@hou2026]. This was shown using (ProteinMPNN) as a base model, and even in situations with multiple constraints. As shown below, this does not lead to sacrificed refoldability metrics.
