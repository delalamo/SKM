...
---
#### Summary
The **categorical Jacobian method** was developed by [@zhang2024] to predict protein contacts using [[notes/protein-language-models|Protein language models]]. Unlike [[ESMFold]] and the [[ESM]] contact prediction head, it is entirely unsupervised and requires no training. It works for [[Transformer|transformers]] but not CNNs.
