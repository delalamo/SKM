...
High-accuracy computational models might not always be effective for ligand docking. Retrospective screens of AlphaFold2 structures cannot recapitulate ligand binding via Rosetta and GLIDE, even when ligand-binding pockets are correctly modeled ([10.7554__elife.89386.1|Karelina et al 2023]; Chris de Graaf's presentation at the 2022 EMBL AlphaFold workshop). In contrast, prospective screens on two G protein-coupled receptors using AlphaFold models have been successful ([10.1126__science.adn6354|Lyu et al 2024]), while [10.1021__acs.jcim.3c01976|Gu et al 2024] found that AlphaFold2 models were comparable in usefulness for virtual screening to apo structures but inferior to holo structures.

#### Details

This is contrary to work with DiffDock, with 22% of its top ranked ligands within 2Å of the target predicted by ESMFold, which could be due to its ability to "generalize to imperfect structures" ([10.48550__arXiv.2210.01776|Corso et al 2023]).

The success of prospective screens by [10.1126__science.adn6354|Lyu et al 2024] was attributed to the flexibility of the binding pocket of their target:
