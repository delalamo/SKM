...
---
#### Summary
**There is insufficient [[tags/antibodies|antibody]]-antigen binding data to train statistical or machine learning docking models to high accuracy, even when the data points are simulated** [@hummer2023]. Authors say at least 90,000 structures are required for prediction quality to plateau.
