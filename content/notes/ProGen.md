...
[@ruffolo2025] generated four million [[CRISPR-Cas9|CRISPR]] proteins and one million [[CRISPR-Cas9|Cas9]] proteins using fine-tuned versions of ProGen. Half were prompted with the N- or C-terminal 50 residues of natural enzymes, while the other half were fully *de novo*. The generated sequences were well distributed across the various sub-families of these proteins, and the observed [[plddt|pLDDT]] values from [[alphafold2|AlphaFold2]] were above 80 for >80% and >99.4%, respectively.
