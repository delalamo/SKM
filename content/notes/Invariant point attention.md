...
The **invariant point attention** module of [[notes/AlphaFold2|AlphaFold2]] is a widely used SE(3)-invariant module used to process protein structures. It's used for other tasks including error estimation (IgFold; [@ruffolo2023]), processing of [[cryo-EM]] density (ModelAngelo, [@jamali2024]), [[notes/Inverse folding|inverse folding]] ([@akpinaroglu2023], [[ProteinMPNN#Variations|ProteinIPMP]]), [[notes/Protein backbone design|protein backbone design]] [@billera2024; @huguet2024], and conformational sampling [@lu2024a]. Liu et al. [@liu2025b] released a faster version of this called FlashIPA.

#### Notes

* **The invariant point attention can be retrained and used for domain segmentation** [@lau2023].
* **Training [[notes/RoseTTAFold|RosettaFold]]2 with invariant point attention instead of the [[SE3-transformer]] led to "unstable training performance"** [@baek2023].
