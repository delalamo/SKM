...
---
#### Summary
**During [[notes/Affinity maturation|affinity maturation]], clonal expansion correlates with antigen binding, and larger clonal families are more likely to bind with higher affinity than smaller ones** [@robinson2014]. Put another way, overrepresented [[tags/antibodies|antibodies]] are more likely to be strong binders than weak binders. This fact was used to train AntiBERTy [@ruffolo2021].
