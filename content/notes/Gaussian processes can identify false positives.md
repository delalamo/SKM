...
---
#### Summary
**Gaussian processes can identify false positives.** [^tonner2022] found, using a [[Gaussian processes|Gaussian process]]-based model, that the GFP data by [^sarkisyan2016] had false positives.
