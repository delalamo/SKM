...
**Deep learning [[tags/structure-prediction#Sidechain prediction|sidechain prediction]] methods outperform classical energy function-based methods** ([@visani2023], Heo and [@heo2023; @vangaru2025]). SCWRL4, which is a classical method that uses force fields, did not sample outlier rotamers as often as alternative DL-based method (Heo and [@heo2023]).
