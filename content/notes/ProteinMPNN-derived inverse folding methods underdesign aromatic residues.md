...
#### Summary
**(ProteinMPNN) and derivative methods underdesign aromatic residues** (Staerk et al 2025[^staerk2025], Pacesa et al 2025[^pacesa2025]). This is suggested by the authors of BindCraft to be why [[Diffusion models|diffusion]]-based [[Protein backbone design|backbone design]] plus [[Inverse folding|inverse folding]] with ProteinMPNN underperform [[Inversion of protein folding neural networks|hallucination]]-based methods on binder design.

#### Details
Chow et al 2025[^chow2025] also note overdesign of alanines by RFD-MPNN pipelines:
...
#### Figures
![](/assets/Pasted-image-20251027123228.png)
*Figure from BoltzGen paper*

![](/assets/Pasted-image-20251027123248.png)
*Figure from Pacesa et al 2025[^pacesa2025]*

![](/assets/Pasted-image-20260327090832.png)
*Figure from Chow et al 2025[^chow2025]*
