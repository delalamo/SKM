...
---
#### Summary
**Stability and function trade off during design, and usually substitutions boosting activity lead to decreases in stability** [^tokuriki2008]. This is true of (antibodies) and enzymes. By contrast, [^sennett2023] find no such tradeoff among sequences designed by [[Ancestral sequence reconstruction|ancestral sequence reconstruction]], whi[^muir2024] also find no trade-off in a diverse pool of extant adenylate kinase variants, suggesting that this trade-off is highly local in nature and not "global" across a specific enzyme class.
