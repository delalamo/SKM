...
**[[tags/protein-language-models|PLMs]] and PLM-based [[tags/structure-prediction|structure predictors]] generalize to some *de novo* designed proteins** [@verkuil2022]. Synthetic proteins designed using [[ESM]] were successfully expressed in the wet lab and adopted a structure consisted with predicted contacts. Likewise, [[ESMFold]] correctly predicted the structures of other de novo designed proteins (such as those designed by [@praetorius2023]; see [@del2023]).
