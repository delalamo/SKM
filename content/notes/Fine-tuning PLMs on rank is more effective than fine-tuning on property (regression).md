...
**Fine-tuning [[notes/Protein language models|Protein language models]] using rank information is more effective than fine-tuning using absolute property measurements (regression;** [@hawkinshooker2024]). It also converts a dataset of $N$ sequences to $N^{2}$ pairwise comparisons, while generalizing better to unseen positions.
