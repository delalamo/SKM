...
- **The sequence capacity of a protein exceeds $10^{23}$ for even small proteins (35-40 AAs), but the fraction of [[notes/thermostability|stable]] states is extremely small and inversely correlated with protein size.** These values were estimated using [[Potts models]] [@tian2017].
