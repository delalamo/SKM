...
**Using evolutionary information for label smoothing when training [[tags/inverse-folding|inverse folding]] models improves [[tags/variant-effect-prediction|variant effect prediction]].** Zhou et al. used the [[tags/blosum62|BLOSUM62]] matrix, whereas Gong et al. [@gong2024] used PSSMs. By contrast, Dauparas et al. used uniform smoothing [@zhou2024; @dauparas2022].
