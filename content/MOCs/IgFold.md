...
* Includes some distilled training data from [[AlphaFold|AlphaFold2]]
* Error estimation also uses [[Invariant point attention]]
* A study found it to generate [[DL antibody prediction tools introduce D-amino acids and cis-amide bonds|unrealistic bond lengths and angles]], particularly in [[Complementarity-determining regions#CDRH3|CDRH3]]
