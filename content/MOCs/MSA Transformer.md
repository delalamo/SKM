...
* **MSA transformer outperforms [[Protein language models|PLMs]] and [[Inverse folding]] models on [[Stability and thermostability|stability prediction]] when fine-tuned on the [[10.1038__s41586-023-06328-6|Tsuboyama et al 2023]] dataset** ([[10.1093__bioinformatics__btae447|Cuturello et al 2024]]). This includes [[Hybrid sequence-structure models|hybrid sequence-structure methods]] like ProstT5.
