...
![](/assets/Cytokines-fig.png)
*Figure from [[10.1002__adtp.202100035|Pires et al 2021]]*

#### Functional categorizations

* Type I cytokines, mediate development of cellular response: [[Interleukins#Interleukin-2|IL-2]], [[Interleukins#Interleukin-12|IL-12]], [[Interferons#Interferon gamma|IFN-g]]
...
Synthetic cytokines that dimerize novel receptor pairs. This has been achieved using [[Interleukins#Interleukin-2|IL-2]], [[Interleukins#Interleukin-4|IL-4]], and [[Interferons#Type I IFN|type I interferons]]. These can also include [[Nanobodies]] and [[Single chain variable fragments]] that mediate receptor dimerization.

#### Antibody-cytokine conjugates

* Fusing [[Fc-regions]] to cytokines reduces renal clearance ([[_Articles that need citations|citation needed]]) and intracellular digestion via [[FcRn]]-mediated uptake. This approach has been tested with [[Interleukins#Interleukin-2|IL-2]], [[Interleukins#Interleukin-7|IL-7]], [[Interleukins#Interleukin-15|IL-15]], [[Interleukins#Interleukin-22|IL-22]]. The major challenge is dealing with the fact that Fc regions are dimeric, and many cytokines are not.
* One example is a [[Nanobodies|nanobody]] fused to [[Interleukins#Interleukin-2|IL-2]] or [[Interferons#Interferon gamma|IFN-g]] that targets [[PD-L1]]
* Another is the IL-10-Pavilizumab hybrid, where [[Cytokines can be added to antibody CDRs|monomerized IL-10 was added to CDRL1]].
...
Masked IFNs get around ubiquitous expression of receptor by conjugating to soluble receptor via matrix metalloprotease-cleavable linker to conceal cytokine until it reaches tumor microenvironment, where high concentrations of the protease are present.
Also done with IL-12, IL-2, IFN-beta

#### Miscellaneous

* Dimeric [[Cytokines]] have been monomerized using various approaches:
	* [[Interleukins#Interleukin-10|IL-10]] via a GGGSGG linker
